...
function HomeStack() {
  return (
    ...
    >
      ...
      <Stack.Screen name="Web Portal" component={WebViewScreen} options={{ title: '🌐 LifeLink Web Portal' }} />
    </Stack.Navigator>
  );
}
  ...
  return (
    <NavigationContainer>
      ...
      <Tab.Navigator
        screenOptions={({ route }) => ({
          ...
          tabBarIcon: ({ focused }) => {
            ...
            else if (route.name === 'AI Assistant') icon = '🤖';
      ...
      >
        ...
        <Tab.Screen name="AI Assistant" component={AiAssistantScreen} options={{ title: 'LifeLink AI' }} />
